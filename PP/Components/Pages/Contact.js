  ...
  let [fontsLoaded] = useFonts({
   ...
   if (!fontsLoaded) {
    ...
    {/* THIS IS THE UPPER MENU CODE */}
        <View style={styles.topMenu}>
            <View style={{paddingVertical:'3%'}}>
                <View style={styles.burgerMenu}></View>
                <View style={styles.burgerMenu}></View>
                <View style={styles.burgerMenu}></View>
            </View>
    ...
    {/* THIS IS THE USER INFO */}
        <View style={styles.user}>
            ...
            <View style={{alignItems:'flex-end',justifyContent:'flex-end', padding:'1.5%'}}>
                <Image style={styles.userImage} resizeMode='contain' source={require('./assets/man-pngrepo-com.png')} />
            </View>
    ...
    {/* THIS IS THE USER RELATIVE CODE */}
        <View>
          <TouchableOpacity style={styles.relativeCards}>
